...
<style>
  ...
  .qa-page .admin-card-header {
    display:flex;
    align-items:center;
    justify-content:space-between;
  }
  .qa-page .admin-table tbody tr:hover {
    background:#f8fafc;
  }
  .qa-page .badge {
    padding:3px 10px;
...
<div class="qa-page">
  <div class="admin-section-header">
    <div>
      ...
      <p class="admin-section-subtitle">Giữ UI đồng bộ với danh mục, giúp team duyệt nhanh.</p>
    </div>
  </div>
        ...
        <tr>
          ...
          <td>
            ...
            <form method="post" action="index.php?c=qa&a=deleteQuestion"
              ...
              <button type="submit" class="wd-icon-btn danger" title="Xóa câu hỏi">🗑</button>
            </form>
          </td>
        </tr>
      <?php endforeach; ?>
