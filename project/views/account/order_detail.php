...
<section class="container my-4">
    <div class="row g-4">
                                ...
                                <?php foreach ($items as $item): ?>
                                    <?php 
                                        ...
                                        if (!empty($dbPath)) {
                                            ...
                                            // Ảnh mặc định
                                            $imgSrc = 'https://dummyimage.com/50x70/eee/999?text=No+Img';
                                        }
                                    ?>
                                    <tr>
                                        <td>
     ...
     style="width: 80px; height: 120px; object-fit: cover; border: 1px solid #ccc; border-radius: 4px; margin-right: 15px;">
