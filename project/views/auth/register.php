<section class="card" style="max-width:520px; padding:16px">
  ...
  <form action="index.php?controller=auth&action=register" method="POST" ...>
    ...
    <input type="password"id="password"name="password"requiredminlength="6"class="text"style="width:100%; margin-top:5px;">

    <label for="confirm_password" style="display:block; margin-top:10px;">Xác nhận mật khẩu</label>
    <input type="password"id="confirm_password"name="confirm_password"requiredminlength="6"class="text"style="width:100%; margin-top:5px;">
